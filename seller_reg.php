    ...
    <div class="row d-flex h-100">
      <div class="col-lg-8 col-xl-6"><br><br>
        <div class="card rounded-3">
          ...
          <h1 class="get_text">SellerRegistration</h1>
      <center><h3 ><span style="background-color:yellow;border-radius:13px">&nbsp; ! &nbsp;</span>" Admin gets the 5% of your profit on selling product "</h3></center>
      

            <form class="px-md-2" action="sellerregaction.php" method="post">
            ...
            <textarea name="address" placeholder="You Address..."class="form-control" style="width:100%" required></textarea>
              ...
              <div class="form-outline mb-4">
            <input type="text" class="form-control" name="phonenumber"  patttern="[0-9]{10}" placeholder="Phone Number" required>
            </div>
            ...
            <input type="password" class="form-control" placeholder="Password" name="password"required>
              ...
              <div class="form-outline mb-4">
            <input type="number" id="input_value" class="form-control" pattern=[0-9]{14} required placeholder="Upload you adhar" name="adhar">
          </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const checkUniqueButton = document.getElementById("check_unique");

    checkUniqueButton.addEventListener("click", function () {
        const value = inputField.value;

        if (value.trim() === "") {
            validationResult.innerHTML = "Please enter a value.";
            return;
        }

        // Send an AJAX request to the server to check uniqueness
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                validationResult.innerHTML = response;
            }
        };

        xhr.send("input_value=" + value);
    });
});
